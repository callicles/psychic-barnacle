      ...
      <div className="mx-auto max-w-2xl py-12 px-6 lg:max-w-5xl">
        <div className="mt-9 max-w-2xl">
          ...
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            {" "}
            I am Nicolas, a Tech Leader, Engineer and Entrepreneur based in
            Portland, OR. I am part of the Nike Virtual Studio founding team,
            where we build the future of virtual collectibles and community for
            Nike.
          </p>
        </div>
      </div>
