...
export const meta = {
  ...
  description:
    "This is a comparison between two popular CSS frameworks, Foundation 4 and Bootstrap 3.",
};
...
{/* <Image src={bootstrapPersonalization} alt="test" /> */}
![Bootstrap Personalization](/images/blog/2013-09-17-foundation-vs-bootstrap/bootstrap-personalization.png)
